  ...
  <div class="col-xl-8 col-md-12">
    ...
    <div class="row mt-2 mb-5 pb-3 mx-2">
      ...
      <div class="card card-body mb-5">
        ...
        <p style="text-align: justify">Below are list of hotels nearby with tentative prices. You need to contact person in contact details. Request to all of you that given information is for your help and request you to make payment on arrival and no advance should be given for booking. Booking with advance is at your own risk. </p>
        <br/>
